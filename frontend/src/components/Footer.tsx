  ...
  return (
    <footer className="bg-gradient-to-b from-[#0b1730] to-[#070f22] text-gray-300">
      ...
      <div className="border-b border-white/5">
        <div className="mx-auto flex max-w-[1300px] flex-col items-center justify-center px-10 py-6 text-center md:py-10">
      ...
      {/* MAIN FOOTER LINKS */}
      <div className="mx-auto max-w-[1300px] px-10 py-8 md:py-10">
      ...
      <div className="border-t border-white/10 bg-[#060a17]">
        <div className="mx-auto flex max-w-[1300px] flex-col items-center justify-center px-10 py-4 text-xs text-gray-400">
