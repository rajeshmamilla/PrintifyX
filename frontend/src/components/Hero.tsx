  ...
  return (
    <section className="relative min-h-[420px] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-[520px] flex-col items-center justify-center px-6 text-center">
        ...
        <a
          href="#categories"
          className="mt-10 rounded border border-black px-8 py-3 text-black font-bold transition-all duration-400 hover:bg-black hover:text-white inline-block uppercase tracking-[0.2em] text-sm"
        >
          Order Now
        </a>
      </div>
