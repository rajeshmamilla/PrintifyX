        ...
        <div className="mt-2 pt-2 border-t border-gray-100">
            ...
            {!isAdmin && (
                <div className="flex flex-row gap-4">
                    <button
                        onClick={onAddToCart}
                        className="flex-1 h-10 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg transition-colors flex items-center justify-center shadow-md text-sm"
                    >
                        Add to Cart
                    </button>
                    <button
